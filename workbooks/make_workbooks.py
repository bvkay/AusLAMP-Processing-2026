...
near = [o for o in obs_here if geo.distance_km((lat0, lon0), (o[2], o[3])) < 1500]   # <- 1500 km, for the frame
...
if len(sites_scan) == 0:
    ...
    print("VERDICT: PASS -- all %d sites drawn, %d of %d observatories fall within 1500 km and are drawn, "
          "coastline %d vertices" % (drawn, len(near), len(obs_here), len(lon_c)))
'''),
...
NOTEBOOKS = {"01_survey.ipynb": WB01}
